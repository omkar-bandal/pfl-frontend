...
export declare const setFarmerData: import("@reduxjs/toolkit").ActionCreatorWithPayload<GetFarmer[], "farmerData/setFarmerData">, setSelectedFarmer: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetFarmer | undefined, "farmerData/setSelectedFarmer">;
