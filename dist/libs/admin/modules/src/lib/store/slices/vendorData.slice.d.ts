...
export declare const setVendorData: import("@reduxjs/toolkit").ActionCreatorWithPayload<GetVendor[], "vendorData/setVendorData">, setSelectedVendor: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetVendor | undefined, "vendorData/setSelectedVendor">;
