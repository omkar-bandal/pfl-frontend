...
const initKeyMobileNumbers = {
    ...
    ref1MName: '',
    ref1LName: '',
    ref1Address: initValAddress_1.initValAddress,
    ref1ContactNo: '',
    ref1Email: '',
    ref2FName: '',
    ref2MName: '',
    ref2LName: '',
    ref2Address: initValAddress_1.initValAddress,
    ref2ContactNo: '',
    ref2Email: '',
};
const initBillingDetails = {
    ...
    contactPersonLName: '',
    commonlyKnownAs: '',
    billingAddress: initValAddress_1.initValAddress,
...
const initDeliveryDetails = {
    deliveryAddress: initValAddress_1.initValAddress,
...
const initBankDetails = {
    ...
    bankAccNo: '',
    ifscCode: '',
    bankAddress: initValAddress_1.initValAddress,
};
...
exports.initValCustomer = {
    ...
    organisationType: '',
    otherType: '',
    customerAddress: initValAddress_1.initValAddress,
    primaryContactNo: '',
    secondaryContactNo: '',
    emailPrimary: '',
    emailSecondary: '',
