...
var oe = (t, e, n) => (Or(t, e, "read from private field"), n ? n.call(t) : e.get(t)), at = (t, e, n) => e.has(t) ? yn("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), ut = (t, e, n, o) => (Or(t, e, "write to private field"), o ? o.call(t, n) : e.set(t, n), n), ct = (t, e, n) => (Or(t, e, "access private method"), n);
const Ti = {
  //Authentication
  SIGNIN: "/auth/login",
  SIGNOUT: "/auth/logout"
...
function vn(t) {
  return JSON.stringify(
    t,
    (e, n) => Do(n) ? Object.keys(n).sort().reduce((o, s) => (o[s] = n[s], o), {}) : n
  );
}
function Fo(t, e) {
...
var Be, Me, be, ke, je, Ht, kr, In, Io = (In = class extends jo {
  constructor(e, n) {
    super();
    at(this, je);
    at(this, Be);
  ...
  setOptions(e) {
    ...
    this.options = oe(this, Be).defaultMutationOptions(e), Fo(this.options, n) || oe(this, Be).getMutationCache().notify({
      type: "observerOptionsUpdated",
      mutation: oe(this, be),
      observer: this
    }), n != null && n.mutationKey && this.options.mutationKey && vn(n.mutationKey) !== vn(this.options.mutationKey) ? this.reset() : ((o = oe(this, be)) == null ? void 0 : o.state.status) === "pending" && oe(this, be).setOptions(this.options);
  }
  onUnsubscribe() {
    var e;
  ...
  onMutationUpdate(e) {
    ct(this, je, Ht).call(this), ct(this, je, kr).call(this, e);
  }
  getCurrentResult() {
    return oe(this, Me);
  }
  reset() {
    var e;
    (e = oe(this, be)) == null || e.removeObserver(this), ut(this, be, void 0), ct(this, je, Ht).call(this), ct(this, je, kr).call(this);
  }
  mutate(e, n) {
    var o;
    return ut(this, ke, n), (o = oe(this, be)) == null || o.removeObserver(this), ut(this, be, oe(this, Be).getMutationCache().build(oe(this, Be), this.options)), oe(this, be).addObserver(this), oe(this, be).execute(e);
  }
}, Be = new WeakMap(), Me = new WeakMap(), be = new WeakMap(), ke = new WeakMap(), je = new WeakSet(), Ht = function() {
  var n;
  const e = ((n = oe(this, be)) == null ? void 0 : n.state) ?? Lo();
  ut(this, Me, {
    ...e,
  ...
  Un.batch(() => {
    var n, o, s, u, c, d, g, v;
    if (oe(this, ke) && this.hasListeners()) {
      const m = oe(this, Me).variables, w = oe(this, Me).context;
      (e == null ? void 0 : e.type) === "success" ? ((o = (n = oe(this, ke)).onSuccess) == null || o.call(n, e.data, m, w), (u = (s = oe(this, ke)).onSettled) == null || u.call(s, e.data, null, m, w)) : (e == null ? void 0 : e.type) === "error" && ((d = (c = oe(this, ke)).onError) == null || d.call(c, e.error, m, w), (v = (g = oe(this, ke)).onSettled) == null || v.call(
        g,
        void 0,
        e.error,
        m,
...
function Uo() {
  ...
  _.prototype.isReactComponent = {}, _.prototype.setState = function(l, b) {
  ...
  var ie = Array.isArray, U = Object.prototype.hasOwnProperty, Z = { current: null }, ce = { key: !0, ref: !0, __self: !0, __source: !0 };
  function me(l, b, N) {
    ...
    return { $$typeof: t, type: l, key: X, ref: J, props: W, _owner: Z.current };
  }
  function Se(l, b) {
  ...
  var T = { current: null }, Oe = { transition: null }, We = { ReactCurrentDispatcher: T, ReactCurrentBatchConfig: Oe, ReactCurrentOwner: Z };
  function Ce() {
  ...
  return D.Children = { map: le, forEach: function(l, b, N) {
    ...
    return l;
  } }, D.Component = _, D.Fragment = n, D.Profiler = s, D.PureComponent = x, D.StrictMode = o, D.Suspense = g, D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = We, D.act = Ce, D.cloneElement = function(l, b, N) {
    ...
    if (b != null) {
      if (b.ref !== void 0 && (X = b.ref, J = Z.current), b.key !== void 0 && (W = "" + b.key), l.type && l.type.defaultProps) var Y = l.type.defaultProps;
...
function Bo() {
  return En || (En = 1, function(t, e) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var n = "18.3.1", o = Symbol.for("react.element"), s = Symbol.for("react.portal"), u = Symbol.for("react.fragment"), c = Symbol.for("react.strict_mode"), d = Symbol.for("react.profiler"), g = Symbol.for("react.provider"), v = Symbol.for("react.context"), m = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), I = Symbol.for("react.suspense_list"), M = Symbol.for("react.memo"), S = Symbol.for("react.lazy"), A = Symbol.for("react.offscreen"), _ = Symbol.iterator, q = "@@iterator";
      function x(r) {
      ...
      };
      {
        var W = {
          ...
          Object.defineProperty(B.prototype, r, {
            get: function() {
              we("%s(...) is deprecated in plain JavaScript React classes. %s", i[0], i[1]);
            }
          });
        };
        for (var J in W)
      ...
      function Ve(r) {
        if (tt(r))
          return T("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", nr(r)), Fe(r);
      }
      function Tt(r, i, f) {
        var h = r.displayName;
        if (h)
      ...
      function ar(r, i, f) {
        ...
        if (i != null) {
          pt(i) && (O = i.ref, G = Z.current), De(i) && (Ve(i.key), C = "" + i.key);
          var ee;
          r.type && r.type.defaultProps && (ee = r.type.defaultProps);
          for (h in i)
            ze.call(i, h) && !rt.hasOwnProperty(h) && (i[h] === void 0 && ee !== void 0 ? R[h] = ee[h] : R[h] = i[h]);
        }
      ...
      function Ke(r, i) {
        return typeof r == "object" && r !== null && r.key != null ? (Ve(r.key), cr("" + r.key)) : i.toString(36);
      }
      function Le(r, i, f, h, R) {
        ...
        if (O) {
          ...
          if (et($)) {
            var ee = "";
            G != null && (ee = Pe(G) + "/"), Le($, i, ee, "", function(xo) {
              return xo;
            });
          } else $ != null && (Ne($) && ($.key && (!k || k.key !== $.key) && Ve($.key), $ = ir(
            $,
        ...
        var te, ne, ue = 0, de = h === "" ? xt : h + ur;
        if (et(r))
          for (var Vt = 0; Vt < r.length; Vt++)
            te = r[Vt], ne = de + Ke(te, Vt), ue += Le(te, i, f, ne, R);
        else {
          var Sr = x(r);
          if (typeof Sr == "function") {
            var pn = r;
            Sr === pn.entries && (ot || we("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), ot = !0);
            for (var Ao = Sr.call(pn), hn, ko = 0; !(hn = Ao.next()).done; )
              te = hn.value, ne = de + Ke(te, ko++), ue += Le(te, i, f, ne, R);
          } else if (C === "object") {
            var mn = String(r);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, R), R.default;
      ...
      function a(r) {
        return !!(typeof r == "string" || typeof r == "function" || r === u || r === d || ye || r === c || r === w || r === I || pe || r === A || $e || dt || qe || typeof r == "object" && r !== null && (r.$$typeof === S || r.$$typeof === M || r.$$typeof === g || r.$$typeof === v || r.$$typeof === m || // This needs to include all possible module reference object
...
` + br + r;
      ...
      function Zr(r, i) {
        ...
        var C;
        C = vr.current, vr.current = null, lo();
        try {
          if (i) {
            var O = function() {
              throw Error();
...
`), $ = h.stack.split(`
`), G = k.length - 1, ee = $.length - 1; G >= 1 && ee >= 0 && k[G] !== $[ee]; )
              ee--;
            for (; G >= 1 && ee >= 0; G--, ee--)
              if (k[G] !== $[ee]) {
                if (G !== 1 || ee !== 1)
...
` + k[G].replace(" at new ", " at ");
                      return r.displayName && te.includes("<anonymous>") && (te = te.replace("<anonymous>", r.displayName)), typeof r == "function" && Bt.set(r, te), te;
                    }
                  while (G >= 1 && ee >= 0);
                break;
              }
          ...
          gr = !1, vr.current = C, fo(), Error.prepareStackTrace = R;
        }
        var ne = r ? r.displayName || r.name : "", ue = ne ? Ut(ne) : "";
      ...
      function yo(r, i, f, h, R) {
        {
          ...
          for (var O in r)
            if (C(r, O)) {
              ...
              k && !(k instanceof Error) && ($t(R), T("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", h || "React class", f, O, typeof k), $t(null)), k instanceof Error && !(k.message in en) && (en[k.message] = !0, $t(R), T("Failed %s type: %s", f, k.message), $t(null));
            }
        }
      }
      function st(r) {
...
Check the top-level render call using <` + f + ">.");
      ...
      function on(r, i) {
        if (!(!r._store || r._store.validated || r.key != null)) {
          ...
          if (!nn[f]) {
            nn[f] = !0;
            var h = "";
            r && r._owner && r._owner !== Z.current && (h = " It was passed a child from " + Te(r._owner.type) + "."), st(r), T('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', f, h), st(null);
          }
        }
      }
      function sn(r, i) {
      ...
      function an(r) {
        {
          ...
          if (f) {
            var h = Te(i);
            yo(f, r.props, "prop", h, r);
          } else if (i.PropTypes !== void 0 && !Er) {
            Er = !0;
            var R = Te(i);
      ...
      function un(r, i, f) {
        ...
        if (h)
          for (var $ = 2; $ < arguments.length; $++)
            sn(arguments[$], r);
        return r === u ? Eo(k) : an(k), k;
      }
      var cn = !1;
      function Ro(r) {
        var i = un.bind(null, r);
        return i.type = r, cn || (cn = !0, we("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")), Object.defineProperty(i, "type", {
          enumerable: !1,
          get: function() {
      ...
      function wo(r, i, f) {
        for (var h = ar.apply(this, arguments), R = 2; R < arguments.length; R++)
      ...
      function dn(r) {
        {
          ...
          if (h !== null && typeof h == "object" && typeof h.then == "function") {
            ...
            if (Wt(i), it === 0) {
              ...
              var ee = {
                then: function(ne, ue) {
                  U.current === null ? (U.current = [], Rr($, ne, ue)) : ne($);
                }
              };
              return ee;
            } else {
      ...
      function Rr(r, i, f) {
        {
          ...
          if (h !== null)
            try {
              _r(h), So(function() {
                h.length === 0 ? (U.current = null, i(r)) : Rr(r, i, f);
              });
            } catch (R) {
              f(R);
            }
      ...
      e.Children = Po, e.Component = B, e.Fragment = u, e.Profiler = d, e.PureComponent = H, e.StrictMode = c, e.Suspense = w, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = le, e.act = dn, e.cloneElement = To, e.createContext = Nt, e.createElement = Oo, e.createFactory = Co, e.createRef = rr, e.forwardRef = hr, e.isValidElement = Ne, e.lazy = pr, e.memo = y, e.startTransition = _o, e.unstable_act = dn, e.useCallback = se, e.useContext = P, e.useDebugValue = Ae, e.useDeferredValue = yt, e.useEffect = F, e.useId = mr, e.useImperativeHandle = Ie, e.useInsertionEffect = fe, e.useLayoutEffect = re, e.useMemo = ve, e.useReducer = z, e.useRef = L, e.useState = V, e.useSyncExternalStore = yr, e.useTransition = he, e.version = n, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Rt, Rt.exports)), Rt.exports;
}
process.env.NODE_ENV === "production" ? xr.exports = Uo() : xr.exports = Bo();
var xe = xr.exports, bt = {};
/**
 * @license React
...
function Mo() {
  ...
  function c(d, g, v) {
    var m, w = {}, I = null, M = null;
    v !== void 0 && (I = "" + v), g.key !== void 0 && (I = "" + g.key), g.ref !== void 0 && (M = g.ref);
    for (m in g) o.call(g, m) && !u.hasOwnProperty(m) && (w[m] = g[m]);
    if (d && d.defaultProps) for (m in g = d.defaultProps, g) w[m] === void 0 && (w[m] = g[m]);
    return { $$typeof: e, type: d, key: I, ref: M, props: w, _owner: s.current };
  }
...
function $o() {
  return wn || (wn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var ie = !1, U = !1, Z = !1, ce = !1, me = !1, Se;
    Se = Symbol.for("react.module.reference");
    function $e(a) {
      return !!(typeof a == "string" || typeof a == "function" || a === o || a === u || me || a === s || a === v || a === m || ce || a === M || ie || U || Z || typeof a == "object" && a !== null && (a.$$typeof === I || a.$$typeof === w || a.$$typeof === c || a.$$typeof === d || a.$$typeof === g || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var ye = Object.assign, le = 0, we, T, Oe, We, Ce, l, b;
    function N() {
    }
    ...
    function B() {
      {
        if (le === 0) {
          we = console.log, T = console.info, Oe = console.warn, We = console.error, Ce = console.group, l = console.groupCollapsed, b = console.groupEnd;
          var a = {
            configurable: !0,
            enumerable: !0,
            value: N,
...
` + F[re].replace(" at new ", " at ");
    ...
    function cr(a, y, E, P, V) {
      {
        var z, L = {}, F = null, fe = null;
        E !== void 0 && (pt(E), F = "" + E), ir(y) && (pt(y.key), F = "" + y.key), sr(y) && (fe = y.ref, ar(y, V));
        for (z in y)
          Fe.call(y, z) && !or.hasOwnProperty(z) && (L[z] = y[z]);
        if (a && a.defaultProps) {
        ...
        return ur(a, F, fe, V, P, De.current, L);
      }
    }
    ...
    function Lt(a, y, E, P, V, z) {
      {
        ...
        if (!L) {
          ...
          fe ? F += fe : F += Je();
          var re;
          a === null ? re = "null" : rt(a) ? re = "array" : a !== void 0 && a.$$typeof === e ? (re = "<" + (pe(a.type) || "Unknown") + " />", F = " Did you accidentally export a JSX literal instead of a component?") : re = typeof a, x("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", re, F);
        }
        var se = cr(a, y, E, V, z);
        if (se == null)
          return se;
        ...
        if (Fe.call(y, "key")) {
          var Ae = pe(a), he = Object.keys(y).filter(function(yr) {
            return yr !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, yt, Ae, mr, Ae), mt[Ae + yt] = !0;
          }
        }
    ...
    var hr = pr, It = dr;
    gt.Fragment = o, gt.jsx = hr, gt.jsxs = It;
  }()), gt;
}
process.env.NODE_ENV === "production" ? Mo() : $o();
var qo = xe.createContext(
  void 0
), Wo = (t) => {
  const e = xe.useContext(qo);
  if (!e)
...
function Bn(t, e) {
  ...
  const s = xe.useSyncExternalStore(
    ...
    (c, d) => {
      o.mutate(c, d).catch(Ho);
    },
    [o]
  );
  if (s.error && Vo(o.options.throwOnError, [s.error]))
    throw s.error;
...
const { toString: zo } = Object.prototype, { getPrototypeOf: Mr } = Object, Gt = /* @__PURE__ */ ((t) => (e) => {
  const n = zo.call(e);
  return t[n] || (t[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), _e = (t) => (t = t.toLowerCase(), (e) => Gt(e) === t), Xt = (t) => (e) => typeof e === t, { isArray: lt } = Array, wt = Xt("undefined");
function Yo(t) {
  return t !== null && !wt(t) && t.constructor !== null && !wt(t.constructor) && Re(t.constructor.isBuffer) && t.constructor.isBuffer(t);
}
const $n = _e("ArrayBuffer");
function Ko(t) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(t) : e = t && t.buffer && $n(t.buffer), e;
}
const Jo = Xt("string"), Re = Xt("function"), qn = Xt("number"), Qt = (t) => t !== null && typeof t == "object", Go = (t) => t === !0 || t === !1, zt = (t) => {
  if (Gt(t) !== "object")
    return !1;
  const e = Mr(t);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Symbol.toStringTag in t) && !(Symbol.iterator in t);
}, Xo = _e("Date"), Qo = _e("File"), Zo = _e("Blob"), es = _e("FileList"), ts = (t) => Qt(t) && Re(t.pipe), rs = (t) => {
  let e;
...
}, ns = _e("URLSearchParams"), [os, ss, is, as] = ["ReadableStream", "Request", "Response", "Headers"].map(_e), us = (t) => t.trim ? t.trim() : t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
function _t(t, e, { allOwnKeys: n = !1 } = {}) {
...
const Xe = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Vn = (t) => !wt(t) && t !== Xe;
function jr() {
  const { caseless: t } = Vn(this) && this || {}, e = {}, n = (o, s) => {
    const u = t && Wn(e, s) || s;
    zt(e[u]) && zt(o) ? e[u] = jr(e[u], o) : zt(o) ? e[u] = jr({}, o) : lt(o) ? e[u] = o.slice() : e[u] = o;
  };
  for (let o = 0, s = arguments.length; o < s; o++)
    arguments[o] && _t(arguments[o], n);
  return e;
}
const cs = (t, e, n, { allOwnKeys: o } = {}) => (_t(e, (s, u) => {
  n && Re(s) ? t[u] = Mn(s, n) : t[u] = s;
  ...
  for (; e-- > 0; )
    n[e] = t[e];
  return n;
}, ms = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && Mr(Uint8Array)), ys = (t, e) => {
  ...
  for (; (n = t.exec(e)) !== null; )
    o.push(n);
  return o;
}, bs = _e("HTMLFormElement"), gs = (t) => t.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, o, s) {
    return o.toUpperCase() + s;
  }
), _n = (({ hasOwnProperty: t }) => (e, n) => t.call(e, n))(Object.prototype), Es = _e("RegExp"), Hn = (t, e) => {
...
}, Ss = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, Tr = "abcdefghijklmnopqrstuvwxyz", Sn = "0123456789", zn = {
  DIGIT: Sn,
  ALPHA: Tr,
  ALPHA_DIGIT: Tr + Tr.toUpperCase() + Sn
}, Os = (t = 16, e = zn.ALPHA_DIGIT) => {
  let n = "";
  const { length: o } = e;
  for (; t--; )
    n += e[Math.random() * o | 0];
...
const Cs = (t) => {
  ...
  return n(t, 0);
}, Ps = _e("AsyncFunction"), As = (t) => t && (Qt(t) || Re(t)) && Re(t.then) && Re(t.catch), Yn = ((t, e) => t ? setImmediate : e ? ((n, o) => (Xe.addEventListener("message", ({ source: s, data: u }) => {
  ...
  Re(Xe.postMessage)
), ks = typeof queueMicrotask < "u" ? queueMicrotask.bind(Xe) : typeof process < "u" && process.nextTick || Yn, p = {
  isArray: lt,
  isArrayBuffer: $n,
  isBuffer: Yo,
  isFormData: rs,
  ...
  function m(S, A, _) {
    ...
    if (S && !_ && typeof S == "object") {
      if (p.endsWith(A, "{}"))
        ...
        return A = Gn(A), q.forEach(function(K, ie) {
          !(p.isUndefined(K) || K === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            c === !0 ? On([A], ie, u) : c === null ? A : A + "[]",
            v(K)
          );
        }), !1;
    }
    return Fr(S) ? !0 : (e.append(On(_, A, u), v(S)), !1);
  }
  const w = [], I = Object.assign(Fs, {
    defaultVisitor: m,
    convertValue: v,
    isVisitable: Fr
  });
...
}, Ns = typeof URLSearchParams < "u" ? URLSearchParams : $r, Ls = typeof FormData < "u" ? FormData : null, Is = typeof Blob < "u" ? Blob : null, Us = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Ns,
    FormData: Ls,
...
}, qr = typeof window < "u" && typeof document < "u", Dr = typeof navigator == "object" && navigator || void 0, Bs = qr && (!Dr || ["ReactNative", "NativeScript", "NS"].indexOf(Dr.product) < 0), Ms = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", $s = qr && window.location.href || "http://localhost", qs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: qr,
...
class Ee {
  ...
  set(e, n, o) {
    ...
    function u(d, g, v) {
      ...
      (!w || s[w] === void 0 || v === !0 || v === void 0 && s[w] !== !1) && (s[w || g] = Yt(d));
    }
...
}, kn = (t) => (...e) => p.asap(() => t(...e)), ri = ge.hasStandardBrowserEnv ? (
...
const xn = (t) => t instanceof Ee ? { ...t } : t;
function Ze(t, e) {
  e = e || {};
  const n = {};
  function o(v, m, w) {
  ...
  return p.forEach(Object.keys(Object.assign({}, t, e)), function(m) {
    const w = g[m] || s, I = w(t[m], e[m], m);
    p.isUndefined(I) && w !== d || (n[m] = I);
  }), n;
}
const oo = (t) => {
  const e = Ze({}, t);
  let { data: n, withXSRFToken: o, xsrfHeaderName: s, xsrfCookieName: u, headers: c, auth: d } = e;
  e.headers = c = Ee.from(c), e.url = Qn(no(e.baseURL, e.url), t.params, t.paramsSerializer), d && c.set(
    "Authorization",
  ...
  if (p.isFormData(n)) {
    if (ge.hasStandardBrowserEnv || ge.hasStandardBrowserWebWorkerEnv)
      ...
      const [v, ...m] = g ? g.split(";").map((w) => w.trim()).filter(Boolean) : [];
  ...
  return new Promise(function(n, o) {
    ...
    let { responseType: d, onUploadProgress: g, onDownloadProgress: v } = s, m, w, I, M, S;
    function A() {
    ...
    }, u === void 0 && c.setContentType(null), "setRequestHeader" in _ && p.forEach(c.toJSON(), function(ie, U) {
      _.setRequestHeader(U, ie);
    }), p.isUndefined(s.withCredentials) || (_.withCredentials = !!s.withCredentials), d && d !== "json" && (_.responseType = s.responseType), v && ([I, S] = Kt(v, !0), _.addEventListener("progress", I)), g && _.upload && ([w, M] = Kt(g), _.upload.addEventListener("progress", w), _.upload.addEventListener("loadend", M)), (s.cancelToken || s.signal) && (m = (K) => {
      _ && (o(!K || K.type ? new ft(null, t, _) : K), _.abort(), _ = null);
...
}, er = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", so = er && typeof ReadableStream == "function", di = er && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((t) => (e) => t.encode(e))(new TextEncoder()) : async (t) => new Uint8Array(await new Response(t).arrayBuffer())), io = (t, ...e) => {
  try {
    return !!t(...e);
  } catch {
    return !1;
  ...
  return t && !e;
}), Fn = 64 * 1024, Nr = so && io(() => p.isReadableStream(new Response("").body)), Jt = {
  stream: Nr && ((t) => t.body)
};
er && ((t) => {
...
const hi = async (t) => {
  ...
  let _;
  try {
    if (g && pi && n !== "get" && n !== "head" && (_ = await mi(m, o)) !== 0) {
      let U = new Request(e, {
        method: "POST",
        body: o,
        duplex: "half"
    ...
    if (Nr && (d || K && A)) {
      ...
      const Z = p.toFiniteNumber(x.headers.get("content-length")), [ce, me] = d && An(
        Z,
        Kt(kn(d), !0)
      ) || [];
      x = new Response(
...
const Dn = (t) => `- ${t}`, vi = (t) => p.isFunction(t) || t === null || t === !1, ao = {
  getAdapter: (t) => {
    t = p.isArray(t) ? t : [t];
    const { length: e } = t;
    let n, o;
    ...
    for (let u = 0; u < e; u++) {
      n = t[u];
      let c;
      if (o = n, !vi(n) && (o = Lr[(c = String(n)).toLowerCase()], o === void 0))
...
function Nn(t) {
  return Ar(t), t.headers = Ee.from(t.headers), t.data = Pr.call(
    t,
    t.transformRequest
  ), ["post", "put", "patch"].indexOf(t.method) !== -1 && t.headers.setContentType("application/x-www-form-urlencoded", !1), ao.getAdapter(t.adapter || St.adapter)(t).then(function(o) {
...
` + u) : o.stack = u;
  ...
  _request(e, n) {
    ...
    if (!g) {
      ...
      for (S.unshift.apply(S, d), S.push.apply(S, v), I = S.length, m = Promise.resolve(n); w < I; )
        m = m.then(S[w++], S[w++]);
      return m;
    }
    I = d.length;
...
function co(t) {
  const e = new Qe(t), n = Mn(Qe.prototype.request, e);
...
Q.mergeConfig = Ze;
Q.AxiosHeaders = Ee;
Q.formToJSON = (t) => eo(p.isHTMLForm(t) ? new FormData(t) : t);
Q.getAdapter = ao.getAdapter;
Q.HttpStatusCode = Ur;
Q.default = Q;
const tr = {
  //Authentication
...
}), Ri = () => localStorage.getItem("access_token"), wi = () => localStorage.getItem("refresh_token");
...
Br.interceptors.response.use(
  ...
  async (t) => {
    ...
    if (t.response && t.response.status === 401 && !e._retry) {
      ...
      if (n)
        try {
          const { data: o } = await Q.post(`${tr.BASE_URL}/auth/refresh-token`, {
            refreshToken: n
          });
          return localStorage.setItem("accessToken", o.accessToken), e.headers.Authorization = `Bearer ${o.accessToken}`, Br(e);
        } catch (o) {
...
const _i = async (t, e) => {
  var n;
  try {
    return (await Q.post(`${tr.BASE_URL}${t}`, e, {
      headers: {
        // 'ngrok-skip-browser-warning': 'true',
...
export {
  Ti as AUTH_API_URL,
  Ci as useSignInService,
  Pi as useSignOutService
};
