import { Address, GetFilteredBranchData } from '../../../../admin_api/src/index.ts';
...
export type GetLaborBankDetails = {
    id: string;
} & PostLaborBankDetails;
...
export type GetLaborFamilyDetails = {
    id: string;
} & PostLaborFamilyDetails;
...
export type GetLaborWorkExperience = {
    id: string;
} & PostLaborWorkExperience;
