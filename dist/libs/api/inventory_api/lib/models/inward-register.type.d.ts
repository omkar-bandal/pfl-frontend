import { ApprovalSummany, DocumentStatus, FormProductQtyAmt, FormProducts, FormProductUoM, FormProductWeight } from '../../../../common_api/src/index.ts';

export interface IInwardProducts extends FormProducts, FormProductUoM, FormProductQtyAmt, FormProductWeight {
    weight: number | null;
}
