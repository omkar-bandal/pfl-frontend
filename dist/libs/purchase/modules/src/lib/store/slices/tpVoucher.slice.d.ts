...
export declare const setPreviewTPVoucher: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<PostTPvoucher | undefined, "tp_voucher/setPreviewTPVoucher">, setSelectedTPVoucher: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetTPvoucher | undefined, "tp_voucher/setSelectedTPVoucher">, setTPVouchers: import("@reduxjs/toolkit").ActionCreatorWithPayload<GetTPvoucher[], "tp_voucher/setTPVouchers">;
