...
export declare const setPMPVouchers: import("@reduxjs/toolkit").ActionCreatorWithPayload<GetPMPvoucher[], "pmp_voucher/setPMPVouchers">, setPreviewPMPVoucher: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<PostPMPvoucher | GetPMPvoucher | undefined, "pmp_voucher/setPreviewPMPVoucher">, setSelectedPMPVoucher: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetPMPvoucher | undefined, "pmp_voucher/setSelectedPMPVoucher">;
