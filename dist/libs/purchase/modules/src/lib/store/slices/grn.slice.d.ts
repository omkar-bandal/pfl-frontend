...
export declare const setGRNData: import("@reduxjs/toolkit").ActionCreatorWithPayload<GetGRN[], "grnData/setGRNData">, setSelectedGRN: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetGRN | undefined, "grnData/setSelectedGRN">, setPreviewGRN: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<GetGRN | PostGRN | undefined, "grnData/setPreviewGRN">, setSubTotalAmt: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, "grnData/setSubTotalAmt">, setTotalAmt: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, "grnData/setTotalAmt">, setTotAmtWords: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, "grnData/setTotAmtWords">;
