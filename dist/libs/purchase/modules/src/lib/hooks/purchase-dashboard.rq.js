...
exports.useGetDashboardData = useGetDashboardData;
...
function useGetDashboardData(filterParams) {
    return (0, react_query_1.useQuery)({
        queryKey: ['get-dashboard-data', filterParams],
        queryFn: () => purchase_api_1.PurchaseDashboardServices.getInstance().getDashboardData(filterParams),
