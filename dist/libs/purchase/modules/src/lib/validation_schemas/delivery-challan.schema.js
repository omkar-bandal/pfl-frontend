...
exports.dcTypeStockTransferSchema = exports.dcTypeCustomerSchema = void 0;
...
exports.dcTypeCustomerSchema = dcBaseSchema.shape({
    customerName: yup.string().required('Name is required'),
    fromLocation: yup.string().required('Location is required'),
});
exports.dcTypeStockTransferSchema = dcBaseSchema.shape({
