...
exports.rfpaSchema = yup.object().shape({
    ...
    purchaseForSalesLocation: yup.string().test('is-required-conditional-sales', 'Purchase for sales location is required.', function (value) {
    ...
    deliveryReceivingPerson: yup
        .string()
        .matches(modules_1.REGEX.IS_STRING, 'Please enter a valid name')
