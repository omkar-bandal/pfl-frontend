...
import { ProductPartialData, QueryParams } from '@prime-fresh/services';
import { AutoCompleteInput, FormikScrollableAutocomplete } from '../formik-form';
import {
  ...
  return (
    <>
      <Grid2 size={{ xs: 12, md: 4 }}>
        <FormikScrollableAutocomplete<ProductPartialData>
          isRequired={true}
