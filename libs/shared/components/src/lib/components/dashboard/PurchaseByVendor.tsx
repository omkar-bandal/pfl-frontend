...
import { useGetVendorsPartialData, useGetPurchaseDataByVendor, debounce, useDebounce } from '@prime-fresh/shared/modules';
...
const debouncedSearch = useDebounce(vendorSearch, 500);
  ...
  const handlePrevPage = () => {
    ...
    const handleInputChange = (_: any, newInput: string) => setVendorSearch(newInput);
