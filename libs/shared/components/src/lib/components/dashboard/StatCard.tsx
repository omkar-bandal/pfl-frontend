          ...
          <Box sx={{ width: '100%', height: 50 }}>
            <SparkLineChart
              ...
              slotProps={{
                ...
                tooltip: {
                  // Apply custom styling using the standard MUI sx prop
                  sx: {
                    // 1. General Container Style (Paper component)
                    backgroundColor: 'rgba(255, 255, 255, 0.95)',
                    boxShadow: '0 8px 20px rgba(0, 0, 0, 0.3)',
                    borderRadius: 2,
                    border: `1px solid #95A5A6`, // Dynamic color border
                    // p: 1.5,
                    '& .MuiChartsTooltip-value': {
                      fontWeight: 'bold',
                      fontSize: '1rem',
                      color: chartColor, // Make the value text match the trend color
                    },
                    '& .MuiChartsTooltip-label': {
                      color: '#333', // Darker color for the label (e.g., 'data point')
                    },
                    '& table, & th, & td': {
                      all: 'unset',
                      display: 'flex',
