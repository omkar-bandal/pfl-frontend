...
interface MultiSelectAutocompleteProps<T extends OptionType> extends Omit<LabelProps, 'isReadOnly' | 'isError'> {
  placeholder?: string;
  helperText?: string;
...
export function MultiSelectAutocomplete<T extends OptionType>(props: MultiSelectAutocompleteProps<T>) {
  const {
    name,
    options,
    getOptionLabel,
