...
export const VendorRegistrationForm = () => {
    ...
    const handleSubmit = async (values: any) => {
        ...
        vendorId === "" ? (mutatePost(formData).then(() => {
    ...
    const formParts = [<VendorPrimaryDetails />, <VendorOtherDetails />, <VendorSalesContact />, <VendorBankDetails />, <VendorReferences />]
    return (
        isLoading ? 
        (<Box flex={1}>
            <LinearProgress />
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <Grid2 container columnSpacing={1} rowSpacing={1} padding={1}>
                        ...
                        <Grid2 size={{ xs: 12 }}>
                            ...
                            <Box sx={{ flex: 1 }}>
                                <FormTabs
                                    tabLabels={sharedData.vendorFormTabs}
                                    value={tab}
