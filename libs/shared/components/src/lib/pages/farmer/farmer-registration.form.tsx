...
export const FarmerRegistrationForm = () => {
  ...
  const farmerFormTabs: TabOptions[] = [
    { label: 'Farmer Details', isDisabled: false },
    { label: 'Farm Details', isDisabled: false },
    { label: 'Crop Details', isDisabled: false },
    { label: 'Images', isDisabled: false },
  ];
  return isLoading ? (
    <Box flex={1}>
      <LinearProgress />
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <Grid2 container columnSpacing={1} rowSpacing={1} padding={1}>
            ...
            <Grid2 size={{ xs: 12 }}>
              ...
              <Box sx={{ flex: 1 }}>
                <FormTabs tabOptions={farmerFormTabs} value={tab} handleChange={handleTabChange} />
