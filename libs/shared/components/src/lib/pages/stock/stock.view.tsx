...
import { DataViewer, ObjectViewerConfig, SectionConfig } from '../../components';
...
export const StockView = () => {
  ...
  const stockDataConfig: SectionConfig[] = [
    {
      sectionType: 'object',
      icon: <Inventory />,
      title: 'Stock Details',
  ...
  return (
    <Box flex={1}>
      {isLoading ? (
        ...
        <DataViewer config={stockDataConfig} data={stockData !== null ? stockData : {}} />
      )}
    </Box>
  );
};
