...
import { FileUpload, SelectInput, TextInput } from '../../../components';
...
export const CustomerStatutoryDetails = () => {
  ...
  return (
    <Grid2 container spacing={1}>
      ...
      <Grid2 size={{ xs: 12, md: 3 }}>
        <FileUpload isRequired={false} name="statutoryDetails.panCopy" label="Copy of PAN Card" />
      </Grid2>
      <Grid2 size={{ xs: 12, md: 3 }}>
        <TextInput
          type="text"
      ...
      <Grid2 size={{ xs: 12, md: 3 }}>
        <FileUpload isRequired={false} name="statutoryDetails.aadharCopy" label="Copy of Aadhar Card" />
      </Grid2>
      ...
      <Grid2 size={{ xs: 12, md: 4 }}>
        <FileUpload isRequired={false} name="statutoryDetails.regiCertificateCopy" label="Copy of Registration certificate" />
      </Grid2>
      <Grid2 size={{ xs: 12, md: 4 }}>
        <TextInput
          type="text"
      ...
      <Grid2 size={{ xs: 12 }}>
        <FileUpload isRequired={false} name="billBookCopy" label="Copy of Bill Book or Bilty attached" />
      </Grid2>
      <Grid2 size={{ xs: 12, md: 3 }}>
        <SelectInput
          isRequired={false}
