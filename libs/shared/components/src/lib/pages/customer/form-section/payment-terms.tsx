...
import { FileUpload, RadioGroupInput, SectionHeader, SelectInput, TextInput } from '../../../components';
...
export const CustomerPaymentTerms = () => {
  ...
  return (
    <Grid2 container spacing={1}>
      ...
      <Grid2 size={{ xs: 12, md: 3 }}>
        <FileUpload isRequired={false} name="lc" label="L/C" />
      </Grid2>
      <Grid2 size={{ xs: 12, md: 3 }}>
        <FileUpload isRequired={false} name="bg" label="B/G" />
      </Grid2>
      <Grid2 size={{ xs: 12 }}>
      ...
      <Grid2 size={{ xs: 12 }}>
        <FileUpload isRequired={false} name="docEvidenceCopy" label="Documentary Evidence" />
      </Grid2>
      <Grid2 size={{ xs: 12 }}>
        <TextInput
          type="text"
