...
export const CustomerBankDetails = () => {
  ...
  return (
    <Grid2 container spacing={1} padding={1}>
      ...
      <AddressFormFields
        fieldPrefix="bankDetails.bankAddress"
      ...
      <Grid2 size={{ xs: 12, md: 4 }}>
        <FileUpload isRequired={false} name="bankDetails.bankStatementCopy" label="Copy of Bank Statement" />
      </Grid2>
      <Grid2 size={{ xs: 12, md: 4 }}>
        <RadioGroupInput
          isRequired={true}
      ...
      <Grid2 size={{ xs: 12, md: 4 }}>
        <FileUpload isRequired={false} name="bankDetails.cancelledChequeCopy" label="Copy of cancelled cheque" />
      </Grid2>
