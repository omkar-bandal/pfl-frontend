...
export const vendorValidationSchema = [vendorPrimaryDetailValidaton, vendorOtherDetailsValidation, vendorSaleInfoValidation, vendorBankDetailsValidation, vendorReferenceValidation];