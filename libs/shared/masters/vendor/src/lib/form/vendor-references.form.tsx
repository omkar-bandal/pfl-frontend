        ...
        <Grid container spacing={1} padding={1}>
            <Grid item xs={12} marginY={1}>
                <Box sx={{ width: '100%', borderBottom: '1px solid #BDBDBD' }}>
                    <Typography variant='body2' sx={{ fontWeight: 600 }}>Vendor Reference 1</Typography>
                </Box>
            </Grid>
            <Grid item xs={12} md={4}>
                <TextInput isRequired={false} name="ref1FName" label="First Name" value={values.ref1FName} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={4}>
                <TextInput isRequired={false} name="ref1MName" label="Middle Name" value={values.ref1MName} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={4}>
                <TextInput isRequired={false} name="ref1LName" label="Last Name" value={values.ref1LName} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={4}>
                <TextInput isRequired={false} name="ref1PrimaryCNumb" label="Primary Contact Number" value={values.ref1PrimaryCNumb} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={4}>
            ...
            <Grid item xs={12} md={6}>
                <TextInput isRequired={false} name="ref1Address.address1" label="Address Line 1" value={values.ref1Address.address1} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={3}>
                <TextInput isRequired={false} name="ref1Address.location" label="Location" value={values.ref1Address.location} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={3}>
                <TextInput isRequired={false} name="ref1Address.city" label="City" value={values.ref1Address.city} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={3}>
                <TextInput isRequired={false} name="ref1Address.state" label="State" value={values.ref1Address.state} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} md={3}>
                <TextInput isRequired={false} name="ref1Address.pincode" label="Pincode" value={values.ref1Address.pincode} handleChange={handleChange} />
            </Grid>
            <Grid item xs={12} marginY={1}>
                <Box sx={{ width: '100%', borderBottom: '1px solid #BDBDBD' }}>
                    <Typography variant='body2' sx={{ fontWeight: 600 }}>Vendor Reference 2</Typography>
                </Box>
            </Grid>
            <Grid item xs={12} md={4}>
