...
import { FormButtonGroup } from "../buttons";

export const DynamicForm = <T extends object>({ initialValues, schema, validationSchema, handleSubmit, isSubmitError }: DynamicFormProps<T>) => {
      ...
      {({ handleReset, isSubmitting }) => (
        <Form>
          <Grid container alignItems="center">
            <Grid item xs={12}>
              <PageTitle pagetitle={schema.title} />
            </Grid>
            <Grid item xs={12}>
              {schema.tabs &&
