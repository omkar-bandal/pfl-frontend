...
import { PaymentRequestServices, GetPaymentRequest, PostPaymentRequest } from '@prime-fresh/purchase_api'; 
import { useMutation, UseMutationResult, useQuery, UseQueryResult } from '@tanstack/react-query';

export function useCreatePaymentRequest(grnid: string):
...
export function useUpdatePaymentRequestById(id: string):
...
export function useDeletePaymentRequestById(id: string):
...
export function useGetAllPaymentRequests():
    UseQueryResult<ApiBaseState<GetPaymentRequest[]>, ErrorModel> {
...
export function useGetPaymentRequestById(id: string):
    UseQueryResult<ApiBaseState<GetPaymentRequest>, ErrorModel> {
    return useQuery<ApiBaseState<GetPaymentRequest>, ErrorModel>({
