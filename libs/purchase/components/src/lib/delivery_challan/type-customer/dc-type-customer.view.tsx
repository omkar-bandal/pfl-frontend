import { Box, Container, Grid2, LinearProgress, TextField, Typography } from '@mui/material';
...
import { BtnSmall, PageTitle, ProgressStep, ProgressStepper, toast } from '@prime-fresh/ui_shared';
...
import { Check, Close, Download, InsertDriveFile, Message } from '@mui/icons-material';
      ...
      {isLoading ? (
        ...
        <Box sx={{ flex: 1, marginY: 1 }}>
          <Grid2 container rowSpacing={1}>
            ...
            <Grid2 size={12} marginY={1} paddingY={2} sx={{ border: `1px dashed #CCC`, borderRadius: 3 }}>
