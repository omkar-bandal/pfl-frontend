...
import { pmpVoucherColumns } from './pmp-voucher.columns';
...
export const PackingMaterialPaymentVoucherTable = () => {
  ...
  const tableNavActionConfig: TableNavActionsConfig = {
    ...
    createPath: PURCHASE_ROUTES.CREATE_PACKING_MATERIAL_VOUCHER,
    editPath: PURCHASE_ROUTES.UPDATE_PACKING_MATERIAL_VOUCHER,
    viewPath: PURCHASE_ROUTES.VIEW_PACKING_MATERIAL_VOUCHER,
  };
