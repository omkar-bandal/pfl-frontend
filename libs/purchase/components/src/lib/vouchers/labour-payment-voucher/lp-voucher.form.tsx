...
import { LPVoucherPreview } from './lp-voucher.preview';
import { setPreview, useAppDispatch } from '@prime-fresh/modules';
import { appendFormData, handleFormKeyDown, mapToValueLabelArray, numToWords, reverseDateString } from '@prime-fresh/shared/modules';
    ...
    <Box flex={1}>
      {isLoading ? (
        ...
        <FormikProvider key={lpVoucherId === '' ? 'create-voucher' : 'update-voucher'} value={formik}>
          <form
            key={lpVoucherId === '' ? 'create-form' : 'update-form'}
            ...
            <Grid2 container columnSpacing={1} rowSpacing={1} padding={1}>
              ...
              <Grid2 size={{ xs: 12, md: 3 }}>
                <TextInput
                  ...
                  value={reverseDateString(formik.values.loadingDate || '')}
                  handleChange={formik.handleChange}
                />
              </Grid2>
              <Grid2 size={{ xs: 12, md: 3 }}>
