...
export const TransportPaymentVoucherView = () => {
  ...
  const { data, isLoading } = useGetTransportPaymentVoucherForViewById(tpVoucherId);
            ...
            <Box sx={{ width: '100%', marginY: 1, padding: 2, border: `1px solid #000000` }}>
              <Grid container>
                <Grid item xs={3} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <Box sx={{ width: 250, height: 100, padding: 1 }}>
                    <img src={images.sidebarlogo} alt="prime-fresh-logo" style={{ width: `100%`, height: `100%` }} />
                  </Box>
                </Grid>
                <Grid item xs={6}>
                  ...
                  <Typography variant="h4" component="div" textAlign="center" sx={{ fontWeight: 700 }}>
                    PRIME FRESH LIMITED
                  </Typography>
                  <Typography variant="caption" component="div" textAlign="center">
                    102, Sanskar-ll, Nr. Ketav Petrol Pump, Polytechnic Road, Ambawadi, Ahmedabad-380015.
                  </Typography>
                  <Typography variant="caption" component="div" textAlign="center">
                    {' '}
                    Ph.:+91-79-40320244, Email: info@primecustomer.co.in, Web: www.primecustomer.co.in
                  </Typography>
                </Grid>
                <Grid item xs={3}>
                  <Typography variant="h6" component="div" textAlign="center" sx={{ color: '#555' }}>
                    Voucher No
                  </Typography>
                  <Typography
                    variant="h6"
                    ...
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell
                          align="center"
                          colSpan={2}
                          sx={{ borderBottom: `1px solid #000000`, fontSize: 17, fontWeight: 'bold' }}
                        >
                          Amount
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell
                          sx={{ borderBottom: `1px solid #000000`, borderRight: `1px solid #000000` }}
                        ></TableCell>
                        <TableCell
                          align="center"
                          sx={{
                    ...
                    <TableBody>
                      {rows.map((row) => (
                        <TableRow key={row.srNo}>
                          ...
                          <TableCell align="center" sx={{ borderBottom: `1px solid #000000` }}>
                            {row.ps}
                          </TableCell>
                        </TableRow>
                      ))}
              ...
              <Grid container marginY={1}>
                <Grid item xs={4} sx={{ border: '1px solid #000000' }}>
                  ...
                  <Typography variant="subtitle1" component="div" textAlign="center" sx={{ color: '#000000' }}>
                    {''}
                  </Typography>
                </Grid>
                <Grid item xs={4} sx={{ border: '1px solid #000000' }}>
