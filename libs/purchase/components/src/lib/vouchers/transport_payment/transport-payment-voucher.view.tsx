...
export const TransportPaymentVoucherView = () => {
    ...
    const rows = [
        createData(1, "Driver Name", tpVoucher?.driverName, "", ""),
        createData(2, "Mob. No.", tpVoucher?.contactNo, "", ""),
        createData(3, "Vehicle No.", tpVoucher?.vehicleNo, "", ""),
        createData(4, "Dispatch Location", tpVoucher?.dispatchLocation, "", ""),
                            ...
                            <Box sx={{ width: '100%', marginY: 1, padding: 2, border: `1px solid #000000` }}>
                                <Grid container>
                                    ...
                                    <Grid item xs={3}>
                                        ...
                                        <Typography variant="h6" component="div" textAlign="center" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.voucherNo}</Typography>
                                    </Grid>
                                </Grid>
                                <Grid container padding={2} columnSpacing={2} rowSpacing={1}>
                                    <Grid item xs={12} md={8}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={9} sx={{ borderBottom: `1px solid #000000` }}>
                                                <Typography variant="subtitle1" component="span" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.debitCreditTo}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={9} sx={{ borderBottom: `1px solid #000000` }}>
                                                <Typography variant="subtitle1" component="span" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.location}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                    <Grid item xs={12} md={8}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={9} sx={{ borderBottom: `1px solid #000000` }}>
                                                <Typography variant="subtitle1" component="span" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.payReceivedFrom}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={9} sx={{ borderBottom: `1px solid #000000` }}>
                                                <Typography variant="subtitle1" component="span" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.createdDate}</Typography>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                                </Grid>
                                        ...
                                        <Grid item xs={10}>
                                            <Grid container rowSpacing={3} columnSpacing={2}>
                                                ...
                                                <Grid item xs={3} sx={{ borderBottom: `1px solid #000000` }}>
                                                    <Typography variant="subtitle1" component="div" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.paymentMode}</Typography>
                                                </Grid>
                                                <Grid item xs={3}>
                                                    <Typography variant="subtitle1" component="div" sx={{ color: "#555" }}>Total Amount :</Typography>
                                                </Grid>
                                                <Grid item xs={3} sx={{ borderBottom: `1px solid #000000` }}>
                                                    <Typography variant="subtitle1" component="div" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.totalAmt}</Typography>
                                                </Grid>
                                                <Grid item xs={3}>
                                                    <Typography variant="subtitle1" component="div" sx={{ color: "#555" }}>Rupees :</Typography>
                                                </Grid>
                                                <Grid item xs={9} sx={{ borderBottom: `1px solid #000000` }}>
                                                    <Typography variant="subtitle1" component="div" sx={{ color: "#000000", fontWeight: 700 }}>{tpVoucher?.amtWords}</Typography>
                                                </Grid>
                                            </Grid>
                                        </Grid>
