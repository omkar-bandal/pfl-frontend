...
export const TransportPaymentVoucherUpdate = () => {
  ...
  const {data: tpVoucherData} = useGetTPVoucher(PURCHASE_API_URL.GET_A_TP_VOUCHER, tpVoucherId);
  ...
  // };
  const { mutateAsync: mutatePatch, isPending, isError, error, data: Res } = useUpdateTPVoucher(PURCHASE_API_URL.UPDATE_TP_VOUCHER, tpVoucherId);
