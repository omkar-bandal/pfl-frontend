import { AppBar, Box, Button, Dialog, Divider, Grid, IconButton, Slide, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Toolbar, Typography } from "@mui/material"
                                ...
                                <TableBody>
                                    {previewRFPA?.rfpaProducts.map((product, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center" sx={{ fontWeight: 400, fontSize: 16 }}>{selectedUOM?.unit}</TableCell>
