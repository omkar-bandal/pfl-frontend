...
export function useCreateEmployee(): UseMutationResult<ResultModel, ErrorModel, FormData, unknown> {
...
export function useUpdateEmployeeById(id: string): UseMutationResult<ResultModel, ErrorModel, FormData, unknown> {
  return useMutation<ResultModel, ErrorModel, FormData, unknown>({
...
export function useGetAllEmployees(queryParams?: QueryParams): UseQueryResult<ApiBaseState<GetEmployee[]>, ErrorModel> {
...
export function useGetEmployeeById(id: string): UseQueryResult<ApiBaseState<GetEmployee>, ErrorModel> {
