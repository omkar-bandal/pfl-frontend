                ...
                >
                  <TableCell align="left">
                    ...
                    >
                      {documentDetails
                        ? convertInTitleCase(
                            documentDetails.find(docDetails => docDetails.id === values.permissions[index]
                  ...
                  <TableCell align="center">
                    <CheckboxInput
                      ...
                      checked={Boolean(
                        values.permissions[index].canCreate
                      )}
                  ...
                  <TableCell align="center">
                    <CheckboxInput
                      ...
                      checked={
                        values.permissions[index].canView
                      }
                      onChange={handleChange}
                    />
                  </TableCell>
                  <TableCell align="center">
                    <CheckboxInput
                      ...
                      checked={
                        values.permissions[index].canEdit
                      }
                      onChange={handleChange}
                    />
                  </TableCell>
                  <TableCell align="center">
                    <CheckboxInput
                      ...
                      checked={
                        values.permissions[index].canDownload
                      }
                      onChange={handleChange}
                    />
                  </TableCell>
                  <TableCell align="center">
                    <CheckboxInput
                      ...
                      checked={
                        values.permissions[index].canDelete
                      }
                      onChange={handleChange}
                    />
                  </TableCell>
