...
import { BtnSmall, PageTitle } from "@prime-fresh/ui_shared";
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Name of Organization </span>
                      </div>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.customerTypes.name}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Customer Category </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.customerCategory.name}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Secondary Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                  ...
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{`${customer?.keyMobileNumbers?.accDeptFName} ${customer?.keyMobileNumbers?.accDeptLName}`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.accDeptMobileNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <div className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Owner or Decision Maker</div>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Name </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{`${customer?.keyMobileNumbers?.ownerFName} ${customer?.keyMobileNumbers?.ownerLName}`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers.ownerMobileNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is mandi licence copy attached? </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.mandiLicenceCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Mandi licence No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.mandiLicenceNo}</span>
                      </div>

                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Is Est. Cert. copy attacted? </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.regiCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Registration Number of Shops & Est. Cert. </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.regiNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is electricity bill (recent) copy attached?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.electricityBillCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Consumer No</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.consumenrNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Reason not to attach electricity bill</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_7}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>{customer?.keyMobileNumbers?.notElectricityBillReason}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>
                          Whether Customer was blacklisted by any company or authority?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers.customerBlacklisted ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Blacklisted By</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.blackListedBy}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Reason For Blacklisting</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.ifBlacklistedReason}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is visiting card copy attached?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers.visitingCardCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Contact No</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.keyMobileNumbers?.visitinContactNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Reason for not attaching visiting card</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_7}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>{customer?.keyMobileNumbers.notVisitingCardReason}</span>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>{customer?.keyMobileNumbers.ref1FName}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Middle Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref1MName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Last Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref1LName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Contact</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers?.ref1ContactNo} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Email</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref1Email} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Address 1 </span>
                      </div>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref2FName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Middle Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref2MName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Last Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref2LName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Contact</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref2ContactNo} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Email</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.keyMobileNumbers.ref2Email} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Address 1 </span>
                      </div>
                  ...
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <div className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Billing Name/Regd. Name </div>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.billingName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Commonly Known As</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.commonlyKnownAs}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Contact Person Details</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>First Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.billingDetails?.contactPersonFName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Middle Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.billingDetails?.contactPersonMName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Last Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.billingDetails?.contactPersonLName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Address 1 </span>
                      </div>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.primaryContactNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Secondary Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.secondaryContactNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Primary Email </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.emailPrimary}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Secondary Email </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.billingDetails?.emailSecondary}</span>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is PAN card copy attached? </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails.panCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Is Aadhar card copy attacted? </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails.addharCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is Registration certificate copy attached?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails.regiCertificateCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_5}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is copy of Bill Book or Bilty attached?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails.billBookCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_11}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is copy of incorporation certificate duly signed by the director if it is a
                          corporate client attached?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_1}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails.incorpoCertificateCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Details of certifications </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails?.certificationsDetails}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Any Other certifications</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails?.otherCertifications}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Registration details</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails?.corpRegiDetails}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Any Other registration details</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.statutoryDetails?.otherCorpRegiDetails}</span>
                      </div>
                    </div>
                  </div>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.deliveryDetails?.receivingPersonFName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Middle Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.deliveryDetails?.receivingPersonMName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>Last Name</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> {customer?.deliveryDetails?.receivingPersonLName} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Primary Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.deliveryDetails?.primaryContactNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Secondary Contact No </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.deliveryDetails?.secondaryContactNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Primary Email </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.deliveryDetails?.emailPrimary}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Secondary Email </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.deliveryDetails?.emailSecondary}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Delivery Time </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.deliveryDetails?.deliveryTime}</span>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{`${customer?.bankDetails?.bankAccHolderFName} ${customer?.bankDetails?.bankAccHolderLName}`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.bankDetails?.ifCancelledCheque ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Is copy of cancel cheque attached ?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.bankDetails?.cancelledChequeCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>If cancelled cheque not attached please specify reason</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.bankDetails?.notCancelledChequeReason}</span>
                      </div>
                    </div>
                  </div>
                  <div className={styles.blockSection}>
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>{customer?.paymentTerms?.otherPaymentMade}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.otherPaymentMode}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>RTV</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.rtv ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Agreement Executed</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.agreementExecuted ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_6}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Margin / Deposit Mutually Agreed </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_6}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.marginDeposit}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Security Deposit Details</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Cheque No</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.securityDepoCheqNo}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Amount</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.securityDepoAmt}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>L/C attached ?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.lc ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>B/G attached ?</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.bg ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Initial Exposure Limit</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_6}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.IELRecommendedBy}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Recommended Date </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.IELRecommendedDate}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Revision of Exposure Limit</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_6}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> In Amount </span>
                      </div>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.RELRecommendedBy}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}> Recommended Date </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.RELRecommendedDate}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Document Evidence </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_9}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.paymentTerms?.docEvidenceCopy ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_3}`}>
                    ...
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textXS} ${styles.textBold}`}>
                          I/We hereby declare that the particulars furnished above are correct and complete. The financial
                          information provided above is to be used by PFL for making payment or receiving payment
                          through electronic mode. I request and authorize PFL to effect payment through electronic mode to my/our
                          bank account as per the details mentioned above. If any transaction is delayed or not
                          effected at all for reasons of incompleteness or incorrectness of information provided as above or any
                          error made by the Bank(s), the Company (Prime Fresh Limited) shall not be held
                          responsible. I/We hereby undertake to inform the Company immediately of any change in my/our bank/branch
                          and account number.
                          No column to be left Blank. All Documents provided should be legible to ensure correctness of the details
                          specified above. </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4} ${styles.signatureBlock}`}>
                        <span className={`${styles.textXS} ${styles.textBold} ${styles.mr}`}>Name & Signature of the Customer</span>
                      </div>
                ...
                <section>
                  <div className={styles.blockSection}>
                    <div className={styles.gridContainer} style={{ padding: `0px 10px` }}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.proposerBDName}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Dispatch Location -PFL </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Relationship Manager </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.pflCoordinator}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.dispatchLocationPfl}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.relationshipManager}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold}`}>Expected average monthly Billing </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.avgBillingMonthly} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Volume in Tonnes per month </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.customerVerification ? `Yes` : `No`} </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>If yes, by which agency and validity </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.verificationAgency}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Due diligence done? </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.dueDiligenceDone ? `Yes` : `No`}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Renewal of Credit worthiness due </span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.creditWorthinessDue}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Key Account Person assigned</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.keyAccountPersonAssigned}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                      ...
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Ledger Verified & Approved By</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.ledgerCreatedDate}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.ledgerCreatedBy}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_4}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly.ledgerVerifiedApprovedBy}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Any other description & Brief of the customer requirement</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.mr}`}>{customer?.officeUseOnly?.additionalNotes}</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Brief Note on feasibility of conducting business and customer acceptance
                          policy of the PFL permits the customer</span>
                      </div>
                      <div className={`${styles.gridItem} ${styles.span_2}`}>
                    ...
                    <div className={styles.gridContainer} style={{ padding: `0px 10px`, margin: `20px auto` }}>
                      <div className={`${styles.gridItem} ${styles.span_12}`}>
                        <span className={`${styles.textSM} ${styles.textBold} ${styles.mr}`}>Note: Ensure that Customer requirement sheet(s), product specifications
                          including packing details are attached as a separate document and marked as annexure. Customer SOP,
                          Business Transaction document and a copy of the Profile of the customer are collected/ created and
                          attached along with this form</span>
                      </div>
                    </div>
                    <div className={styles.addressBlock}>
                      <div className={`${styles.textXS} ${styles.textBold} ${styles.mr}`} style={{ display: `block`, textAlign: `center` }}>Registered and Admin. Office:</div>
                      <div className={`${styles.textXS} ${styles.mr}`} style={{ display: `block`, textAlign: `center` }}>102, Sanskar 2, Pol;ytechnic Road, Near Ketav Petrol Pump, Ambawadi, Ahmedabad - 380 015</div>
                    </div>
                  </div>
                </section>
              </div>
