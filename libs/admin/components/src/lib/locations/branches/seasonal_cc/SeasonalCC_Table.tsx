...
export function SeasonalCCTable() {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const apiRef = useGridApiRef();

    const { data, isLoading } = useGetAllBranches(ADMIN_API_URL.GET_ALL_SEASONAL_CC);
    ...
    const handleCreate = () => {
        ...
        navigate(`${ADMIN_ROUTES.CREATE_BRANCHES}/${BranchType[2]}`);
    };
