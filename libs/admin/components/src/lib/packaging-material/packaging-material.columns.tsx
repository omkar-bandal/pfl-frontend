...
export const usePackagingMaterialColumns = (navigate: NavigateFunction): CustomGridColDef[] => {
  return useMemo(
    () => [
      {
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            aria-label="edit"
            onClick={() => navigate(`${adminRoutes.UPDATE_PACKAGING_MATERIAL}/${params.row.id}`)}
          >
