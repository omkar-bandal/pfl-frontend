...
import { initValProduct, useGetProductById, useUpdateProductById } from '@prime-fresh/admin/modules';
import {
  Box,
  Button,
  CircularProgress,
...
import { appendFormData, productValidationSchema } from '@prime-fresh/shared/modules';
import {
  ProductDetails,
  ProductFormPreview,
  ProductImage,
