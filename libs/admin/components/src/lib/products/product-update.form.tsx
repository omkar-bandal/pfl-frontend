...
import { initValProduct } from "@prime-fresh/admin/modules";
...
import { ADMIN_API_URL, PostProduct, useGetAllProductClassification, useGetAllProductsCat, useGetAllProductSubCat, useGetAllUOMs, useGetAProduct, useUpdateProduct } from "@prime-fresh/admin_api";
...
export const ProductUpdateForm = () => {
    ...
    const {data: product, isLoading} = useGetAProduct(ADMIN_API_URL.GET_A_PRODUCTS, productId);
    console.log(product); 
    ...
    const { mutateAsync: mutatePatch, error: patchError, data: patchRes } = useUpdateProduct(ADMIN_API_URL.UPDATE_PRODUCTS, productId);
