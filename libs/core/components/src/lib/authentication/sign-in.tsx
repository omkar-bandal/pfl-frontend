...
export const SignIn = () => {
    ...
    const { showPassword, signinMethod, loggedInUserInfo } = useAppSelector(authState);

    //actions from authSlice
    const { setShowPassword, setSigninMethod, setLoggedInUserInfo } = useActions();
    ...
    const uidLabel = useMemo(() => signinMethod === "email" ? stringConstants.EMAIL : stringConstants.MOB_NO, [signinMethod]);
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            <Grid container direction="column" rowSpacing={1} padding={1}>
                                ...
                                <Grid item xs={12} marginY={1}>
                                    ...
                                    />
                                    <Typography variant="caption" component="div" color="error">{formik.touched.uid && formik.errors.uid}</Typography>
                                </Grid>
                                <Grid item xs={12} marginY={1}>
                                    <TextField
                                        fullWidth
                                        ...
                                        sx={{ backgroundColor: theme.palette.primary.light }}
                                    />
                                    <Typography variant="caption" component="div" color="error">{formik.touched.password && formik.errors.password}</Typography>
                                </Grid>
                                <Grid item xs={12} marginY={2}>
                                    ...
                                    >
                                        {formik.isSubmitting && !isError ? <CircularProgress size={25} color="inherit" /> : stringConstants.SIGN_IN}
                                    </Button>
                                </Grid>
                            </Grid>
                        </form>
