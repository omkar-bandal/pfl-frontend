...
import { authState, loginSchema, stringConstants, useActions, useAppSelector } from '@prime-fresh/modules';
...
export const Login = () => {
  ...
  const { showPassword } = useAppSelector(authState);

  //actions from authSlice
  const { setShowPassword, setLoggedInUserInfo, setEmployeeLevel, setEmployeePermissions } = useActions();
