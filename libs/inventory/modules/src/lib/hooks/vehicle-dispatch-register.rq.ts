...
import { VehicleDispatchRegisterServices, IVehicleDispatchRegister } from '@prime-fresh/inventory_api';
import { useMutation, UseMutationResult, useQuery, UseQueryResult } from '@tanstack/react-query';

export function useCreateVehicleDispatchRegister():
    UseMutationResult<ResultModel, ErrorModel, Omit<IVehicleDispatchRegister, 'id'>, unknown> {
...
export function useGetAllVehicleDispatchRegisters(queryParams?: QueryParams, search?: string | null):
