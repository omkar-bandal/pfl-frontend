...
export const DumpRegisterTable = () => {
  ...
  const tableNavActionConfig: TableNavActionsConfig = {
    tableId: TABLE_ID,
    createPath: inventoryRouteConstants.CREATE_DUMP_REGISTER,
    editPath: inventoryRouteConstants.UPDATE_DUMP_REGISTER,
    viewPath: inventoryRouteConstants.VIEW_DUMP_REGISTER,
  };
