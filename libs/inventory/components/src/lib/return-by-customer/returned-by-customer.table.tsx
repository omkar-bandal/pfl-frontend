...
import { inventoryRouteConstants, useGetAllReturnedByCustomers } from '@prime-fresh/inventory/modules';
import { IReturnByCustomer } from '@prime-fresh/inventory_api';
import { returedByCustomerColumns } from './returned-by-customer.columns';
...
export const ReturnedByCustomerTable = () => {
  ...
  const tableNavActionConfig: TableNavActionsConfig = {
    tableId: TABLE_ID,
    createPath: inventoryRouteConstants.CREATE_RBC,
    editPath: inventoryRouteConstants.UPDATE_RBC,
    viewPath: inventoryRouteConstants.VIEW_RBC,
  };
