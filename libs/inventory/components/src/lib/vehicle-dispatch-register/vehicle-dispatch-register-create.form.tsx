...
import { inventoryRouteConstants, useCreateVehicleDispatchRegister, vehicleDispatchRegisterInitialValues } from '@prime-fresh/inventory/modules'
...
export const VehicleDispatchRegisterCreateForm = () => {
  ...
  const { mutateAsync, error, data } = useCreateVehicleDispatchRegister();
