...
import { useGetDumpRegisterForViewById } from '@prime-fresh/operations/modules';
...
import {
  ...
  useUpdateDocStatusWithTwoApproval,
          ...
          <Grid container rowSpacing={1} marginBottom={2}>
            ...
            <Grid item xs={12}>
              <DrawerContainer>
                ...
                >{`Current Status: ${convertInTitleCase(dumpData?.overAllStatus || '')}`}</Typography>
            ...
            <Grid item xs={12} alignItems="center">
              <Typography variant="subtitle1" component="span" sx={{ fontWeight: 700, color: '#2C3E50' }}>
                ...
                <Typography
                  variant="subtitle1"
                  component="span"
                  sx={{ marginLeft: 2, fontWeight: 700, color: getDocStatusColor(dumpData?.overAllStatus || 'hold') }}
                >
                ...
                <div className={styles.px}>
                  <table className={styles.voucherTable}>
                    ...
                    <tbody>
                      ...
                      {(dumpData?.dumpProducts.length || 0) < 5 &&
                        Array(5 - (dumpData?.dumpProducts?.length || 0))
                          .fill(null)
                          .map((_, index) => (
