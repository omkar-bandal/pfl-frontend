...
export const useEODReportColumns = (
  canEdit: boolean,
  canView: boolean,
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            ...
            onClick={() => navigate(`${operationsRoutes.UPDATE_EOD_REPORT}/${params.row.id}`)}
          >
            <Edit />
          </IconButton>
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            aria-label="view"
            color="success"
            onClick={() => navigate(`${operationsRoutes.VIEW_AN_EOD_REPORT}/${params.row.documentId}`)}
          >
            <Preview />
          </IconButton>
        ),
