...
export const DCTypeCustomerTable = () => {
  ...
  const { canEdit, canView, canDelete } = usePermission('deliveryChallan-Customer');
  const dcTypeCustomerColumns = useDCTypeCustomerColumns(canEdit, canView, navigate);

  const tableNavActionConfig: TableNavActionsConfig = {
    tableId: dataTableIds.DC_TYPE_CUSTOMER_TABLE_ID,
    createPath: operationsRoutes.CREATE_DC_TYPE_CUSTOMER,
    editPath: operationsRoutes.UPDATE_DC_TYPE_CUSTOMER,
    viewPath: operationsRoutes.VIEW_A_DC_TYPE_CUSTOMER,
  };
