...
export const useDCTypeCustomerColumns = (
  canEdit: boolean,
  canView: boolean,
    ...
    () => [
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            ...
            onClick={() => navigate(`${operationsRoutes.UPDATE_DC_TYPE_CUSTOMER}/${params.row.id}`)}
          >
            <Edit />
          </IconButton>
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            aria-label="view"
            onClick={() => navigate(`${operationsRoutes.VIEW_A_DC_TYPE_CUSTOMER}/${params.row.documentId}`)}
          >
