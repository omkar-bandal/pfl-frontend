...
import {
  initValPaymentRequest,
  paymentRequestSchema,
  staticData,
  operationsRoutes,
  setPreviewPaymentReq,
    ...
    <>
      ...
      >
        {({ values, handleChange, handleSubmit, handleReset, isSubmitting }) => (
          <form onSubmit={handleSubmit} onKeyDown={handleFormKeyDown} encType="multipart/form-data">
            <Grid2 container columnSpacing={1} rowSpacing={1} padding={1}>
              ...
              <Grid2 size={{ xs: 12, md: 4 }}>
                <TextInput
                  ...
                  value={values.typesOfTransaction}
                  handleChange={handleChange}
                />
              </Grid2>
              <Grid2 size={{ xs: 12, md: 4 }}>
                <TextInput
                  ...
                  label="Other Type of Transaction (if any)"
                  value={values.otherTransaction}
                  handleChange={handleChange}
                />
              </Grid2>
              <Grid2 size={{ xs: 12, md: 4 }}>
              ...
              <Grid2 size={{ xs: 12, md: 4 }}>
                <TextInput
                  isRequired={true}
                  name="contactpersonRec"
                  label="Receiver Contact Person"
                  value={values.contactpersonRec}
                  handleChange={handleChange}
                />
              </Grid2>
              <Grid2 size={{ xs: 12, md: 4 }}>
                <TextInput
                  isRequired={true}
                  name="contactpersonSen"
                  label="Sender Contact Person"
                  value={values.contactpersonSen}
                  handleChange={handleChange}
                />
              </Grid2>
              <Grid2 size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                <FormPreviewBtn
                  onClick={() => {
                    dispatch(setPreviewPaymentReq(values));
