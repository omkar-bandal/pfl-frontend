...
import { useGetRFPAForViewById } from '@prime-fresh/operations/modules';
import { BtnSmall, DrawerContainer, InfoTooltip, PageTitle, StepperData, toast, VerticalStepper } from '@prime-fresh/shared/components';
              ...
              <div className={styles.mainContainer}>
                ...
                <div className={styles.signatureContainer}>
                    <div className={styles.signatureBox}>
                      <span className={`${styles.signatureLabel} ${styles.textSM} ${styles.textBold}`}>({rfpa?.createdBy})</span>
                      <span className={`${styles.signatureLabel} ${styles.textSM} ${styles.textBold}`}>Created By</span>
                    </div>
                    <div className={styles.signatureBox}>
                      <span className={`${styles.signatureLabel} ${styles.textSM} ${styles.textBold}`}>Approved By</span>
                    </div>
                    <div className={styles.signatureBox}>
                      <span className={`${styles.signatureLabel} ${styles.textSM} ${styles.textBold}`}>Receiver Sign</span>
                    </div>
                </div>
              </div>
            </div>
