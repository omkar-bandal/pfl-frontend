...
export const useRfpaColumns = (canEdit: boolean, canView: boolean, navigate: NavigateFunction): CustomGridColDef[] => {
  return useMemo(
    () => [
      {
        field: 'overAllStatus',
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            ...
            onClick={() => navigate(`${operationsRoutes.UPDATE_RFPA}/${params.row.id}`)}
          >
            <Edit />
          </IconButton>
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            aria-label="view"
            color="success"
            onClick={() => navigate(`${operationsRoutes.VIEW_A_RFPA}/${params.row.documentId}`)}
          >
            <Preview />
          </IconButton>
        ),
