...
export const useGRNColumns = (canEdit: boolean, canView: boolean, navigate: NavigateFunction): CustomGridColDef[] => {
  return useMemo(
    () => [
      {
        field: 'overAllStatus',
      ...
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            ...
            onClick={() => navigate(`${operationsRoutes.CREATE_PAYMENT_REQ}/${params.row.id}`)}
          >
            <AddCard color="info" />
          </IconButton>
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            ...
            onClick={() => navigate(`${operationsRoutes.UPDATE_GRN}/${params.row.documentId}`)}
          >
            <Edit/>
          </IconButton>
        ),
      },
      {
        ...
        renderCell: (params: GridRenderCellParams) => (
          <IconButton
            aria-label="view"
            onClick={() => navigate(`${operationsRoutes.VIEW_A_GRN}/${params.row.documentId}`)}
          >
