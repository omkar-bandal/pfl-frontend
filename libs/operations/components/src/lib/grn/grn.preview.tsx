...
import { grnDataState, useGetAllDealSlipNums } from '@prime-fresh/operations/modules';
import { farmersDataStates, vendorsDataStates } from '@prime-fresh/shared/modules';
...
import { IGRNProducts } from '@prime-fresh/services';
