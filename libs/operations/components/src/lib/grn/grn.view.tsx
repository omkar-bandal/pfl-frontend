...
import { BtnSmall, DrawerContainer, formatCurrency, formatDate, InfoTooltip, PageTitle, StepperData, toast, VerticalStepper } from '@prime-fresh/shared/components';
import {
  farmersDataStates,
              ...
              <div className={`${styles['details-grid']}`}>
                ...
                <div style={{ width: '75%' }} className={`${styles['payment-terms-grid']}`}>
                  {[
                    ...
                    { label: 'Payment Terms', value: `${grn?.paymentInfo.paymentTerms} Days` },
