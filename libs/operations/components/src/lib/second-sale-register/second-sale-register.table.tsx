...
import { operationsRoutes, useGetAllSecondSaleRegisters } from '@prime-fresh/operations/modules';
...
export const SecondSaleRegisterTable = () => {
  ...
  const secondSaleRegisterColumns = useSecondSaleRegisterColumns(canEdit, canView, navigate);

  const tableNavActionConfig: TableNavActionsConfig = {
    tableId: TABLE_ID,
    createPath: operationsRoutes.CREATE_SECOND_SALE_REGISTER,
    editPath: operationsRoutes.UPDATE_SECOND_SALE_REGISTER,
    viewPath: operationsRoutes.VIEW_A_SECOND_SALE_REGISTER,
  };
