...
import { staticData, operationsRoutes, laborAttendanceInitialValue, laborAttendanceSchema, laborsDetailsInitialValue } from '@prime-fresh/operations/modules'
import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, Typography } from '@mui/material';
import { AutoCompleteInput, FormResetBtn, FormSubmitBtn, SelectInput, TextInput, toast } from '@prime-fresh/shared/components';
import { Add, Remove } from '@mui/icons-material';
import { PostLaborDetails } from '@prime-fresh/services';
...
export const LaborAttendanceForm = () => {
    ...
    //         setTimeout(() => {
    //             navigate(operationsRoutes.GET_ALL_LABOUR_ATTENDANCE);
    //         }, 2000);
    //     }).catch(() => {
                        ...
                        <Grid container rowSpacing={1} columnSpacing={1} padding={1}>
                            ...
                            {/* <Grid item xs={12} md={6}>
                                <SelectInput
                                    ...
                                    options={staticData.companyNames}
                                                ...
                                                <Grid container columnSpacing={1} key={index} alignItems="center" padding={1} sx={{ border: `1px solid #ccc`, borderRadius: 5 }}>
                                                    <Grid item xs={12} md={2}>
                                                        <SelectInput
                                                            ...
                                                            options={staticData.LABOR_EMP_TYPES}
