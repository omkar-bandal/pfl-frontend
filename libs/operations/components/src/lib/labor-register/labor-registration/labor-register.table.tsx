...
import {ILaborRegistration} from '@prime-fresh/services';
import { operationsRoutes, useGetAllLaborRegistration } from '@prime-fresh/operations/modules';
...
export const LaborRegisterTable = () => {
  ...
  const tableNavActionConfig: TableNavActionsConfig = {
    tableId: TABLE_ID,
    createPath: operationsRoutes.CREATE_LABOUR_REGISTER,
    editPath: operationsRoutes.UPDATE_LABOUR_REGISTER,
    viewPath: operationsRoutes.VIEW_A_LABOUR_REGISTER,
  };
