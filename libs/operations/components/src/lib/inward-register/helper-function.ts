...
import { IInwardRegister, FarmerPartialData, GetAllDeliveryChallanNums, GetAllGRNNums, ProductPartialData, UOMPartialData, VendorPartialData } from "@prime-fresh/services";
