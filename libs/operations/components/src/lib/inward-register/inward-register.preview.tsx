...
import { inwardRegisterStates } from '@prime-fresh/operations/modules';
import {IInwardProducts} from '@prime-fresh/services';
...
export const InwardRegisterFormPreview = () => {
  ...
  const inwardSourceInfo: SectionConfig =
    inwardRegisterFormPreview?.source === 'vendor'
      ? {
