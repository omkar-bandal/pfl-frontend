...
import { useGetLaborPaymentVoucherForViewById } from '@prime-fresh/operations/modules';
        ...
        <Box sx={{ flex: 1 }}>
          <Grid container rowSpacing={1}>
            ...
            <Grid item xs={12} md={8} sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
              {lpVoucher?.createdBy !== username.split(' ')[0] && (
                <BtnSmall
                  label="Approve"
            ...
            <Grid item xs={12}>
              <DrawerContainer>
                ...
                >{`Current Status: ${convertInTitleCase(lpVoucher?.overAllStatus || '')}`}</Typography>
            ...
            <Grid item xs={12} alignItems="center">
              <Typography variant="subtitle1" component="span" sx={{ fontWeight: 700, color: '#2C3E50' }}>
                ...
                <Typography
                  variant="subtitle1"
                  component="span"
                  sx={{ marginLeft: 2, fontWeight: 700, color: getDocStatusColor(lpVoucher?.overAllStatus || 'hold') }}
                >
