...
import { useGetMultiCashVoucherForViewById } from '@prime-fresh/operations/modules';
...
export const MultipleCashVoucherView = () => {
  ...
  const signatureLabels = ['Prepared By', 'Verified By', 'Approved By'];
          ...
          <Grid container rowSpacing={1}>
            ...
            <Grid item xs={12}>
              <DrawerContainer>
                ...
                >{`Current Status: ${convertInTitleCase(mcVoucher?.overAllStatus || '')}`}</Typography>
            ...
            <Grid item xs={12} alignItems="center">
              <Typography variant="subtitle1" component="span" sx={{ fontWeight: 700, color: '#2C3E50' }}>
                ...
                <Typography
                  variant="subtitle1"
                  component="span"
                  sx={{ marginLeft: 2, fontWeight: 700, color: getDocStatusColor(mcVoucher?.overAllStatus || 'hold') }}
                >
