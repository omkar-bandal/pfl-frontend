...
import { useGetTransportPaymentVoucherForViewById } from '@prime-fresh/operations/modules';
...
export const TransportPaymentVoucherView = () => {
  ...
  const tableData = [
    ...
    createData(5, 'Product', convertInTitleCase(tpVoucher?.products.join(', ') || '')),
  ...
  const secondGridData = [
    ...
    { title: 'Total Amount:', value: `${Number(tpVoucher?.finalPayableAmt)} Rs.` },
          ...
          <Grid container rowSpacing={1}>
            ...
            <Grid item xs={12}>
              <DrawerContainer>
                ...
                >{`Current Status: ${convertInTitleCase(tpVoucher?.overAllStatus || '')}`}</Typography>
            ...
            <Grid item xs={12} alignItems="center">
              <Typography variant="subtitle1" component="span" sx={{ fontWeight: 700, color: '#2C3E50' }}>
                ...
                <Typography
                  variant="subtitle1"
                  component="span"
                  sx={{ marginLeft: 2, fontWeight: 700, color: getDocStatusColor(tpVoucher?.overAllStatus || 'hold') }}
                >
