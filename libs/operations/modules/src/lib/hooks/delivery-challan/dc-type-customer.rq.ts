...
export const useUpdateDCTypeCustomerById = (
  id: string
...
export const useDeleteDCTypeCustomerById = (
  id: string
...
export function useDeleteMultipleDCTypeCustomers(): UseMutationResult<ResultModel, ErrorModel, Array<string>, unknown> {
...
export function useGetAllDeliveryChallanNums(): UseQueryResult<ApiBaseState<GetAllDeliveryChallanNums[]>, ErrorModel> {
  return useQuery<ApiBaseState<GetAllDeliveryChallanNums[]>, ErrorModel>({
    ...
    queryFn: () => DCTypeCustomerServices.getInstance().getDeliveryChallanNums(),
  });
}
