...
export function useCreateDealSlip(): UseMutationResult<ResultModel, ErrorModel, IDealSlip, unknown> {
...
export function useUpdateDealSlipById(id: string): UseMutationResult<ResultModel, ErrorModel, IDealSlip, unknown> {
  return useMutation<ResultModel, ErrorModel, IDealSlip, unknown>({
...
export function useDeleteDealSlipById(id: string): UseMutationResult<ResultModel, ErrorModel, unknown, unknown> {
...
export function useDeleteMultipleDealSlips(): UseMutationResult<ResultModel, ErrorModel, Array<string>, unknown> {
  return useMutation<ResultModel, ErrorModel, Array<string>, unknown>({
    mutationKey: ['delete-multiple-deal-slips'],
    mutationFn: (data: Array<string>) => DealSlipServices.getInstance().deleteMultipleDealSlips(data),
  });
}
...
export function useGetDealSlipForViewById(id: string): UseQueryResult<ApiBaseState<IDealSlip>, ErrorModel> {
...
export function useGetDealSlipForUpdateById(id: string): UseQueryResult<ApiBaseState<IDealSlip>, ErrorModel> {
  const enabled = id.length > 1 ? true : false;
  return useQuery<ApiBaseState<IDealSlip>, ErrorModel>({
...
export function useGetAllDealSlipNums(): UseQueryResult<ApiBaseState<GetAllDealSlipNums[]>, ErrorModel> {
  return useQuery<ApiBaseState<GetAllDealSlipNums[]>, ErrorModel>({
    ...
    queryFn: () => DealSlipServices.getInstance().getDealSlipNums(),
  });
}
