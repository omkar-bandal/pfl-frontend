...
export function useCreateLaborRegistration(): UseMutationResult<
  ResultModel,
  ErrorModel,
  Omit<ILaborRegistration, 'id'>,
  unknown
> {
...
export function useUpdateLaborRegistration(
  id: string
...
export function useDeleteLaborRegistrationById(
  id: string
...
export function useGetAllLaborRegistration(
...
export function useGetLaborRegistrationById(id: string): UseQueryResult<ApiBaseState<ILaborRegistration>, ErrorModel> {
