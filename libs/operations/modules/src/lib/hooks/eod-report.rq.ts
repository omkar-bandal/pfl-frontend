...
export function useCreateEODReport(): UseMutationResult<ResultModel, ErrorModel, Omit<IEODReport, 'id'>, unknown> {
...
export function useUpdateEODReport(id: string): UseMutationResult<ResultModel, ErrorModel, IEODReport, unknown> {
...
export function useDeleteEODReportById(id: string): UseMutationResult<ResultModel, ErrorModel, unknown, unknown> {
...
export function useGetEODReportForViewById(id: string): UseQueryResult<ApiBaseState<IEODReport>, ErrorModel> {
  return useQuery<ApiBaseState<IEODReport>, ErrorModel>({
...
export function useGetEODReportForUpdateById(id: string): UseQueryResult<ApiBaseState<IEODReport>, ErrorModel> {
  return useQuery<ApiBaseState<IEODReport>, ErrorModel>({
