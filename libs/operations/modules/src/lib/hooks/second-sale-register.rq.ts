...
export function useCreateSecondSaleRegister(): UseMutationResult<
  ResultModel,
  ErrorModel,
  Omit<ISecondSaleRegister, 'id'>,
  unknown
> {
...
export function useUpdateSecondSaleRegister(
  id: string
...
export function useDeleteSecondSaleRegisterById(
  id: string
...
export function useGetSecondSaleRegisterForViewById(
  id: string
): UseQueryResult<ApiBaseState<ISecondSaleRegister>, ErrorModel> {
...
export function useGetSecondSaleRegisterForUpdateById(
  id: string
): UseQueryResult<ApiBaseState<ISecondSaleRegister>, ErrorModel> {
  const enabled = id.length > 1 ? true : false;
  return useQuery<ApiBaseState<ISecondSaleRegister>, ErrorModel>({
