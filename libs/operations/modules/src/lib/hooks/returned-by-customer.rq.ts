...
export function useCreateReturnedByCustomer(): UseMutationResult<
  ResultModel,
  ErrorModel,
  Omit<IReturnByCustomer, 'id'>,
  unknown
> {
...
export function useUpdateReturnedByCustomer(
  id: string
...
export function useDeleteReturnedByCustomerById(
  id: string
...
export function useGetReturnedByCustomerById(id: string): UseQueryResult<ApiBaseState<IReturnByCustomer>, ErrorModel> {
...
export function useGetReturnedByCustomerForViewById(
  id: string
): UseQueryResult<ApiBaseState<IReturnByCustomer>, ErrorModel> {
  const enable = id.length > 1 ? true : false;
  return useQuery<ApiBaseState<IReturnByCustomer>, ErrorModel>({
...
export function useGetReturnedByCustomerForUpdateById(
  id: string
): UseQueryResult<ApiBaseState<IReturnByCustomer>, ErrorModel> {
  const enable = id.length > 1 ? true : false;
  return useQuery<ApiBaseState<IReturnByCustomer>, ErrorModel>({
